...
import com.netflix.hystrix.examples.*;
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    ...
                    HystrixCommandMetrics.getInstances().stream().forEach(hystrixCommandMetrics -> {
//                        System.out.println("hystrixCommandMetrics.getCommandKey().name() = " + hystrixCommandMetrics.getCommandKey().name());
                        out.append("# " + hystrixCommandMetrics.getCommandKey().name() + ": " + getStatsStringFromMetrics(hystrixCommandMetrics)).append("\n");
                    });
